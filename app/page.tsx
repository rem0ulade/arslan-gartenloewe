      ...
      <section id="start" className="hero">
        ...
        <div className="shell hero-content">
          ...
          <div className="hero-actions">
            <a className="button" href="mailto:info@arslan-gartenloewe.de?subject=Projektanfrage%20über%20die%20Website">Projekt anfragen <i className="arrow-icon" aria-hidden="true" /></a>
            <a className="text-link" href="#projekte">Arbeiten ansehen <i className="arrow-down" aria-hidden="true" /></a>
          </div>
          <div className="hero-proof">
            <a href="https://www.my-hammer.de/auftragnehmer/arslan-gartenpflege-und-gestaltung/bewertungen" target="_blank" rel="noreferrer" aria-label="65 Bewertungen bei MyHammer ansehen"><strong>4,9 / 5 <i className="arrow-icon tiny" aria-hidden="true" /></strong><span>65 Bewertungen auf MyHammer</span></a>
            <a href="https://www.provenexpert.com/de-de/arslan-garten-loewe-gartenpflege-garten-landschaftsbau/" target="_blank" rel="noreferrer" aria-label="Google-Bewertungen über ProvenExpert ansehen"><strong>5,0 / 5 <i className="arrow-icon tiny" aria-hidden="true" /></strong><span>8 Google-Bewertungen</span></a>
            <a href="https://www.gartenbau.org/norderstedt/arslan-garten-loewe-gartenpflege-garten-landschaftsbau-aUOsYJ" target="_blank" rel="noreferrer" aria-label="Bewertung bei Gartenbau.org ansehen"><strong>5,0 / 5 <i className="arrow-icon tiny" aria-hidden="true" /></strong><span>Bewertung auf Gartenbau.org</span></a>
          </div>
        </div>
      </section>
      ...
      <section id="leistungen" className="section services-section reveal">
        <div className="shell">
          ...
          <div className="service-grid">
            {services.map(([n,t,d]) => <article className="service-card" key={n}><span className="service-no">{n}</span><h3>{t}</h3><p>{d}</p><a href="mailto:info@arslan-gartenloewe.de?subject=Anfrage%20zu%20einer%20Leistung" aria-label={`${t} anfragen`}>Anfragen <i className="arrow-icon" aria-hidden="true" /></a></article>)}
          </div>
          <div className="full-services">
            ...
            <ul>{fullServices.map((item,i)=><li key={item} style={{animationDelay:`${i*35}ms`}}><i className="arrow-icon service-arrow" aria-hidden="true" />{item}</li>)}</ul>
          </div>
        </div>
      </section>
